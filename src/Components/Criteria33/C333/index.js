...
class C333 extends Component{
    render(){
        return(
            <div class="sub-card-container">
                <div class="mini-card-container-1">
                    <label class="label-1" for="firstInput">3.3.3:  Number of books and chapters in edited volumes/books published and papers published in national/ international conference preceedings per teacher during last five years</label>
                    <input id="firstInput" class="input-1" type="text"/>
                </div>
                <div class="mini-card-container-2">
                    <label class="label-1" for="firstTable">3.3.3.1:  Total number of books and chapters in edited volumes/books published and papers in national/ international conference preceedings year-wise during last five years</label>
                ...
                <table width={1000} class="table-2" border={2}>
                    ...
                    <tr>
                        <td class="table-2-rows">List books and chapters edited volumes/ books published</td>
